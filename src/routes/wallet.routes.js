...
import { addMoneyToWallet, getAllUsersTransactionHistory, getUserTransactionHistory, requestWithdrawal, getAllWithdrawalsHistory, updateWalletTransactionStatus, requestDeposite, getAllDepositeHistory, updateDepositeTransactionStatus, updateTelegramDepositeTransactionStatus } from "../controllers/wallet.controller.js";
...
router.route("/telegram/update-deposite-transaction-status").put(updateTelegramDepositeTransactionStatus)
